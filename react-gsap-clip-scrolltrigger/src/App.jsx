...
function App() {
  ...
  return (
    <main
      ref={rootRef}
      className="page relative overflow-hidden bg-ink text-paper"
    >
      <BackgroundLine />
      ...
      <header className="fixed left-0 right-0 top-0 z-40 flex items-center justify-between px-5 py-5 md:px-10">
        <a
          href="#top"
          className="text-sm font-semibold uppercase tracking-[0.22em] text-paper"
        >
          Motion Lab
        </a>
        <div className="hidden items-center gap-4 text-xs uppercase tracking-[0.18em] text-paper/55 md:flex">
          <span>GSAP</span>
      ...
      >
        <div className="relative z-10 max-w-5xl">
          <p className="mb-5 text-sm uppercase tracking-[0.24em] text-ember">
            React / Tailwind / GSAP
          </p>
      ...
      {slides.map((slide, index) => (
        <section
          className={`panel ${index === 2 ? "pinned-scene" : ""} relative grid items-center gap-10 px-5 py-24 md:grid-cols-[0.9fr_1.1fr] md:px-10`}
          key={slide.title}
        >
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-reveal mt-7 max-w-md text-base leading-7 text-paper/68 md:text-lg">
              {slide.body}
            </p>
          </div>

          <div className="panel-media relative z-10 mx-auto aspect-square w-full max-w-[680px]">
            <svg
      ...
      <section className="flex min-h-[70vh] items-center justify-center px-5 text-center">
        <div>
          <p className="mb-5 text-sm uppercase tracking-[0.24em] text-mist">
            That is the pattern
          </p>
